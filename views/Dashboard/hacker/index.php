...
<main class="max-w-3xl mx-auto px-4 py-10 space-y-8">
  ...
  <article class="bg-black border border-white/10 rounded-xl">
    ...
    <div class="flex items-center gap-4 p-4">
      ...
      <div>
        <a class="font-semibold" href="<?= $value['project_address']  ?>"><?= $value['project_name']  ?></a>
    ...
    <div class="p-4 space-y-4">
      ...
      <div class="flex flex-wrap gap-4 text-xs text-gray-400">
        <span>💰 Reward: <b class="text-white"><?=  "$".$value['project_price'] ?></b></span>
      ...
      <div class="flex justify-between items-center pt-4 border-t border-white/10">
        <a href="lab.php?site=<?= $value['project_id'] ?>"
